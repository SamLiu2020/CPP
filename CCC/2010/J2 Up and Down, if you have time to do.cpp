...
int main() {
    ...
    if(nikky_leftover <= nikky_f){
        Nikky_steps_taken += nikky_leftover;
    }else{
        Nikky_steps_taken += (nikky_leftover - nikky_f);
    }
    ...
    if(byron_leftover <= byron_f){
        Byron_steps_taken += byron_leftover;
    }else{
        Byron_steps_taken += (byron_leftover - byron_f);
    }

    if (Nikky_steps_taken > Byron_steps_taken){
        cout << "Nikky" << endl;
    } else if (Byron_steps_taken > Nikky_steps_taken){
        cout << "Byron" << endl;
    } else if ((Byron_steps_taken == Nikky_steps_taken)){
        cout << "Tied" << endl;
    }
